    ...
    return (
      ...
      >
        ...
        <div className="flex-1 min-w-0 space-y-2">
          ...
          <div className="h-4 w-3/4 bg-neutral-200 rounded-sm animate-pulse" />
          <div className="h-3.5 w-14 bg-neutral-200 rounded-sm animate-pulse" />
        </div>
      </div>
    )
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        {showBadges && (
          <div className="absolute top-2.5 left-2.5 flex flex-col gap-1.5 z-10">
            <div className="h-4.5 w-16 bg-neutral-200/80 backdrop-blur-xs rounded shadow-xs animate-pulse" />
            <div className="h-4 w-12 bg-neutral-200/60 backdrop-blur-xs rounded shadow-xs animate-pulse hidden sm:block" />
          </div>
        )}
        ...
        {showCornerAction && (
          <div className="absolute top-2.5 right-2.5 z-10">
            <div className="h-6 w-18 rounded-full bg-white/80 backdrop-blur-xs shadow-xs border border-neutral-200/70 animate-pulse" />
          </div>
        )}

        {/* Central Product Icon Placeholder */}
        <div className="w-12 h-12 rounded-xl bg-neutral-200/50 flex items-center justify-center text-neutral-300">
          <svg
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className="h-3 w-16 bg-neutral-200 rounded-sm mb-2 animate-pulse" />

        {/* Product Title (2-line staggered placeholders) */}
        <div className="space-y-1.5 mb-2">
          <div className="h-4.5 w-full bg-neutral-200 rounded animate-pulse" />
          <div className="h-4.5 w-4/5 bg-neutral-200/80 rounded animate-pulse" />
        </div>
        ...
        <div className="mt-auto pt-3 border-t border-neutral-100 flex items-center justify-between gap-2">
          ...
          {showActions && (
            <div className="flex items-center gap-1.5">
              ...
              <div className="h-8 w-14 rounded-lg bg-emerald-50 border border-emerald-200/60 animate-pulse" />
              {/* Quick View Button Placeholder */}
              <div className="h-8 w-20 rounded-lg bg-neutral-100 border border-neutral-200/60 animate-pulse" />
            </div>
          )}
        </div>
      </div>
