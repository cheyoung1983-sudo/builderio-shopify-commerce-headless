...
/**
 * DynamicSEO component that automatically generates and injects
 * Open Graph tags, Twitter Card tags, canonical links, and Schema.org
 * structured data for products, CMS pages, collections, and custom routes.
 */
